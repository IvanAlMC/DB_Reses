...
/* Created on:     05/10/2021 06:33:08 p. m.                    */
/*==============================================================*/
...
(
   ...
   TIPO_PERSONA         CHAR(1)              not null
      constraint CKC_TIPO_PERSONA_PERSONAS check (TIPO_PERSONA in ('T','C','V')),
   SALARIO              NUMBER(8,2),
...
(
   ID_RES               NUMBER(11)           not null,
   NOMBRE_RES           NUMBER(30),
   GENERO               CHAR(1)              not null
      constraint CKC_GENERO_RESES__R check (GENERO in ('M','F')),
